					...
					{persons.map((person, index) => (
						<li
							...
							className={classNames(
								...
								"md:[transition:width_var(--transition,400ms_cubic-bezier(0.4,0,0.2,1))]",
								"md:before-block before:absolute before:bottom-0 before:left-[-10px] before:right-[-10px] before:top-0 before:hidden before:bg-brand",
								"md:[&:not(:hover),&:not(:first),&:not(:last)]:group-hover:w-[7%] md:hover:w-[10%]",
						...
						>
							<div className="relative h-full w-full overflow-hidden rounded-2xl">
								...
								>
									<p className="font-whyte text-sm uppercase text-brand-red md:text-lg">
										{person.title}
									</p>
									<p className="font-dirty text-lg font-bold md:text-4xl">
										{person.name}
									</p>
								</div>
							</div>
